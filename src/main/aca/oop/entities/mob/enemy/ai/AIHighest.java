...
public class AIHighest extends AI {
   Player player;
   Enemy e;
   ...
   public AIHighest(Player p, Enemy e) {
      this.player = p;
      this.e = e;
    ...
    * direction.
      ...
      */
      ...
      public int calculateDirection() {
         if (!direction.isEmpty() && lengthOfPath > 15 && direction.size() > 0.3 * lengthOfPath) {
            return direction.removeFirst();
         }
         ...
         this.lengthOfPath = this.direction.size();
